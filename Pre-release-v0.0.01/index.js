...
var ASM_CONSTS = {
  477670: () => { if (document.fullscreenElement) return 1; },  
 477716: () => { return Module.canvas.width; },  
 477748: () => { return parseInt(Module.canvas.style.width); },  
 477796: () => { document.exitFullscreen(); },  
 477823: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 477895: () => { if (document.fullscreenElement) return 1; },  
 477941: () => { return Module.canvas.width; },  
 477973: () => { return screen.width; },  
 477998: () => { document.exitFullscreen(); },  
 478025: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 478219: () => { return window.innerWidth; },  
 478245: () => { return window.innerHeight; },  
 478272: () => { if (document.fullscreenElement) return 1; },  
 478318: () => { return Module.canvas.width; },  
 478350: () => { return parseInt(Module.canvas.style.width); },  
 478398: () => { if (document.fullscreenElement) return 1; },  
 478444: () => { return Module.canvas.width; },  
 478476: () => { return screen.width; },  
 478501: () => { return window.innerWidth; },  
 478527: () => { return window.innerHeight; },  
 478554: () => { if (document.fullscreenElement) return 1; },  
 478600: () => { return Module.canvas.width; },  
 478632: () => { return screen.width; },  
 478657: () => { document.exitFullscreen(); },  
 478684: () => { if (document.fullscreenElement) return 1; },  
 478730: () => { return Module.canvas.width; },  
 478762: () => { return parseInt(Module.canvas.style.width); },  
 478810: () => { document.exitFullscreen(); },  
 478837: ($0) => { Module.canvas.style.opacity = $0; },  
 478875: () => { return screen.width; },  
 478900: () => { return screen.height; },  
 478926: () => { return window.screenX; },  
 478953: () => { return window.screenY; },  
 478980: () => { return window.devicePixelRatio; },  
 479016: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 479069: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 479120: () => { Module.canvas.style.cursor = 'none'; },  
 479157: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 479413: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 479464: () => { if (document.pointerLockElement) return 1; },  
 479511: () => { if (document.fullscreenElement) return 1; },  
 479557: () => { return window.innerWidth; },  
 479583: () => { return window.innerHeight; }
};
