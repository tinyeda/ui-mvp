...
var ASM_CONSTS = {
  477622: () => { if (document.fullscreenElement) return 1; },  
 477668: () => { return Module.canvas.width; },  
 477700: () => { return parseInt(Module.canvas.style.width); },  
 477748: () => { document.exitFullscreen(); },  
 477775: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 477847: () => { if (document.fullscreenElement) return 1; },  
 477893: () => { return Module.canvas.width; },  
 477925: () => { return screen.width; },  
 477950: () => { document.exitFullscreen(); },  
 477977: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 478171: () => { return window.innerWidth; },  
 478197: () => { return window.innerHeight; },  
 478224: () => { if (document.fullscreenElement) return 1; },  
 478270: () => { return Module.canvas.width; },  
 478302: () => { return parseInt(Module.canvas.style.width); },  
 478350: () => { if (document.fullscreenElement) return 1; },  
 478396: () => { return Module.canvas.width; },  
 478428: () => { return screen.width; },  
 478453: () => { return window.innerWidth; },  
 478479: () => { return window.innerHeight; },  
 478506: () => { if (document.fullscreenElement) return 1; },  
 478552: () => { return Module.canvas.width; },  
 478584: () => { return screen.width; },  
 478609: () => { document.exitFullscreen(); },  
 478636: () => { if (document.fullscreenElement) return 1; },  
 478682: () => { return Module.canvas.width; },  
 478714: () => { return parseInt(Module.canvas.style.width); },  
 478762: () => { document.exitFullscreen(); },  
 478789: ($0) => { Module.canvas.style.opacity = $0; },  
 478827: () => { return screen.width; },  
 478852: () => { return screen.height; },  
 478878: () => { return window.screenX; },  
 478905: () => { return window.screenY; },  
 478932: () => { return window.devicePixelRatio; },  
 478968: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 479021: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 479072: () => { Module.canvas.style.cursor = 'none'; },  
 479109: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 479365: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 479416: () => { if (document.pointerLockElement) return 1; },  
 479463: () => { if (document.fullscreenElement) return 1; },  
 479509: () => { return window.innerWidth; },  
 479535: () => { return window.innerHeight; }
};
