...
var ASM_CONSTS = {
  477638: () => { if (document.fullscreenElement) return 1; },  
 477684: () => { return Module.canvas.width; },  
 477716: () => { return parseInt(Module.canvas.style.width); },  
 477764: () => { document.exitFullscreen(); },  
 477791: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 477863: () => { if (document.fullscreenElement) return 1; },  
 477909: () => { return Module.canvas.width; },  
 477941: () => { return screen.width; },  
 477966: () => { document.exitFullscreen(); },  
 477993: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 478187: () => { return window.innerWidth; },  
 478213: () => { return window.innerHeight; },  
 478240: () => { if (document.fullscreenElement) return 1; },  
 478286: () => { return Module.canvas.width; },  
 478318: () => { return parseInt(Module.canvas.style.width); },  
 478366: () => { if (document.fullscreenElement) return 1; },  
 478412: () => { return Module.canvas.width; },  
 478444: () => { return screen.width; },  
 478469: () => { return window.innerWidth; },  
 478495: () => { return window.innerHeight; },  
 478522: () => { if (document.fullscreenElement) return 1; },  
 478568: () => { return Module.canvas.width; },  
 478600: () => { return screen.width; },  
 478625: () => { document.exitFullscreen(); },  
 478652: () => { if (document.fullscreenElement) return 1; },  
 478698: () => { return Module.canvas.width; },  
 478730: () => { return parseInt(Module.canvas.style.width); },  
 478778: () => { document.exitFullscreen(); },  
 478805: ($0) => { Module.canvas.style.opacity = $0; },  
 478843: () => { return screen.width; },  
 478868: () => { return screen.height; },  
 478894: () => { return window.screenX; },  
 478921: () => { return window.screenY; },  
 478948: () => { return window.devicePixelRatio; },  
 478984: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 479037: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 479088: () => { Module.canvas.style.cursor = 'none'; },  
 479125: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 479381: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 479432: () => { if (document.pointerLockElement) return 1; },  
 479479: () => { if (document.fullscreenElement) return 1; },  
 479525: () => { return window.innerWidth; },  
 479551: () => { return window.innerHeight; }
};
