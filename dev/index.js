...
var ASM_CONSTS = {
  276310: () => { if (document.fullscreenElement) return 1; },  
 276356: () => { return Module.canvas.width; },  
 276388: () => { return parseInt(Module.canvas.style.width); },  
 276436: () => { document.exitFullscreen(); },  
 276463: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 276535: () => { if (document.fullscreenElement) return 1; },  
 276581: () => { return Module.canvas.width; },  
 276613: () => { return screen.width; },  
 276638: () => { document.exitFullscreen(); },  
 276665: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 276859: () => { return window.innerWidth; },  
 276885: () => { return window.innerHeight; },  
 276912: () => { if (document.fullscreenElement) return 1; },  
 276958: () => { return Module.canvas.width; },  
 276990: () => { return parseInt(Module.canvas.style.width); },  
 277038: () => { if (document.fullscreenElement) return 1; },  
 277084: () => { return Module.canvas.width; },  
 277116: () => { return screen.width; },  
 277141: () => { return window.innerWidth; },  
 277167: () => { return window.innerHeight; },  
 277194: () => { if (document.fullscreenElement) return 1; },  
 277240: () => { return Module.canvas.width; },  
 277272: () => { return screen.width; },  
 277297: () => { document.exitFullscreen(); },  
 277324: () => { if (document.fullscreenElement) return 1; },  
 277370: () => { return Module.canvas.width; },  
 277402: () => { return parseInt(Module.canvas.style.width); },  
 277450: () => { document.exitFullscreen(); },  
 277477: ($0) => { Module.canvas.style.opacity = $0; },  
 277515: () => { return screen.width; },  
 277540: () => { return screen.height; },  
 277566: () => { return window.screenX; },  
 277593: () => { return window.screenY; },  
 277620: () => { return window.devicePixelRatio; },  
 277656: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 277709: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 277760: () => { Module.canvas.style.cursor = 'none'; },  
 277797: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 278053: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 278104: () => { if (document.pointerLockElement) return 1; },  
 278151: () => { if (document.fullscreenElement) return 1; },  
 278197: () => { return window.innerWidth; },  
 278223: () => { return window.innerHeight; }
};
