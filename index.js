...
var ASM_CONSTS = {
  276294: () => { if (document.fullscreenElement) return 1; },  
 276340: () => { return Module.canvas.width; },  
 276372: () => { return parseInt(Module.canvas.style.width); },  
 276420: () => { document.exitFullscreen(); },  
 276447: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 276519: () => { if (document.fullscreenElement) return 1; },  
 276565: () => { return Module.canvas.width; },  
 276597: () => { return screen.width; },  
 276622: () => { document.exitFullscreen(); },  
 276649: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 276843: () => { return window.innerWidth; },  
 276869: () => { return window.innerHeight; },  
 276896: () => { if (document.fullscreenElement) return 1; },  
 276942: () => { return Module.canvas.width; },  
 276974: () => { return parseInt(Module.canvas.style.width); },  
 277022: () => { if (document.fullscreenElement) return 1; },  
 277068: () => { return Module.canvas.width; },  
 277100: () => { return screen.width; },  
 277125: () => { return window.innerWidth; },  
 277151: () => { return window.innerHeight; },  
 277178: () => { if (document.fullscreenElement) return 1; },  
 277224: () => { return Module.canvas.width; },  
 277256: () => { return screen.width; },  
 277281: () => { document.exitFullscreen(); },  
 277308: () => { if (document.fullscreenElement) return 1; },  
 277354: () => { return Module.canvas.width; },  
 277386: () => { return parseInt(Module.canvas.style.width); },  
 277434: () => { document.exitFullscreen(); },  
 277461: ($0) => { Module.canvas.style.opacity = $0; },  
 277499: () => { return screen.width; },  
 277524: () => { return screen.height; },  
 277550: () => { return window.screenX; },  
 277577: () => { return window.screenY; },  
 277604: () => { return window.devicePixelRatio; },  
 277640: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 277693: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 277744: () => { Module.canvas.style.cursor = 'none'; },  
 277781: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 278037: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 278088: () => { if (document.pointerLockElement) return 1; },  
 278135: () => { if (document.fullscreenElement) return 1; },  
 278181: () => { return window.innerWidth; },  
 278207: () => { return window.innerHeight; }
};
