...
var ASM_CONSTS = {
  276646: () => { if (document.fullscreenElement) return 1; },  
 276692: () => { return Module.canvas.width; },  
 276724: () => { return parseInt(Module.canvas.style.width); },  
 276772: () => { document.exitFullscreen(); },  
 276799: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 276871: () => { if (document.fullscreenElement) return 1; },  
 276917: () => { return Module.canvas.width; },  
 276949: () => { return screen.width; },  
 276974: () => { document.exitFullscreen(); },  
 277001: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 277195: () => { return window.innerWidth; },  
 277221: () => { return window.innerHeight; },  
 277248: () => { if (document.fullscreenElement) return 1; },  
 277294: () => { return Module.canvas.width; },  
 277326: () => { return parseInt(Module.canvas.style.width); },  
 277374: () => { if (document.fullscreenElement) return 1; },  
 277420: () => { return Module.canvas.width; },  
 277452: () => { return screen.width; },  
 277477: () => { return window.innerWidth; },  
 277503: () => { return window.innerHeight; },  
 277530: () => { if (document.fullscreenElement) return 1; },  
 277576: () => { return Module.canvas.width; },  
 277608: () => { return screen.width; },  
 277633: () => { document.exitFullscreen(); },  
 277660: () => { if (document.fullscreenElement) return 1; },  
 277706: () => { return Module.canvas.width; },  
 277738: () => { return parseInt(Module.canvas.style.width); },  
 277786: () => { document.exitFullscreen(); },  
 277813: ($0) => { Module.canvas.style.opacity = $0; },  
 277851: () => { return screen.width; },  
 277876: () => { return screen.height; },  
 277902: () => { return window.screenX; },  
 277929: () => { return window.screenY; },  
 277956: () => { return window.devicePixelRatio; },  
 277992: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 278045: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 278096: () => { Module.canvas.style.cursor = 'none'; },  
 278133: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 278389: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 278440: () => { if (document.pointerLockElement) return 1; },  
 278487: () => { if (document.fullscreenElement) return 1; },  
 278533: () => { return window.innerWidth; },  
 278559: () => { return window.innerHeight; }
};
